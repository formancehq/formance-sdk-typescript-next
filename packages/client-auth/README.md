...
### [AuthClient SDK](docs/sdks/authclient/README.md)

* [info](docs/sdks/authclient/README.md#info)
...
```typescript
import { AuthClient } from "@formance/sdk-auth";
import { SDKValidationError } from "@formance/sdk-auth/models/errors";
...
```typescript
import { AuthClient } from "@formance/sdk-auth";
import { HTTPClient } from "@formance/sdk-auth/lib/http";
...
const sdk = new AuthClient({ httpClient });
```
...
const sdk = new AuthClient({ debugLogger: console });
```
<!-- End Debugging [debug] -->
...
- [clientsCreate](docs/sdks/clients/README.md#create)
- [clientsDelete](docs/sdks/clients/README.md#delete)
- [clientsGet](docs/sdks/clients/README.md#get)
- [clientsList](docs/sdks/clients/README.md#list)
- [clientsUpdate](docs/sdks/clients/README.md#update)
- [info](docs/sdks/authclient/README.md#info)
