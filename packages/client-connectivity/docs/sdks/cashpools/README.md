...
import { cashPoolsList } from "@formance/sdk-connectivity/funcs/cashPoolsList.js";
...
async function run() {
  const res = await cashPoolsList(connectivityClient);
...
```typescript
import { ConnectivityClientCore } from "@formance/sdk-connectivity/core.js";
import { cashPoolsCreate } from "@formance/sdk-connectivity/funcs/cashPoolsCreate.js";
...
async function run() {
  const res = await cashPoolsCreate(connectivityClient, {
    name: "<value>",
    accountIDs: [
      "<value>",
    ],
...
```typescript
import { ConnectivityClientCore } from "@formance/sdk-connectivity/core.js";
import { cashPoolsGet } from "@formance/sdk-connectivity/funcs/cashPoolsGet.js";
...
async function run() {
  const res = await cashPoolsGet(connectivityClient, "<value>");
...
```typescript
import { ConnectivityClientCore } from "@formance/sdk-connectivity/core.js";
import { cashPoolsDelete } from "@formance/sdk-connectivity/funcs/cashPoolsDelete.js";
...
async function run() {
  const res = await cashPoolsDelete(connectivityClient, "<value>");
...
```typescript
import { ConnectivityClientCore } from "@formance/sdk-connectivity/core.js";
import { cashPoolsAddAccount } from "@formance/sdk-connectivity/funcs/cashPoolsAddAccount.js";
...
async function run() {
  const res = await cashPoolsAddAccount(connectivityClient, "<value>", {
    accountID: "<value>",
  });
...
```typescript
import { ConnectivityClientCore } from "@formance/sdk-connectivity/core.js";
import { cashPoolsRemoveAccount } from "@formance/sdk-connectivity/funcs/cashPoolsRemoveAccount.js";
...
async function run() {
  const res = await cashPoolsRemoveAccount(connectivityClient, "<value>", "<value>");
...
```typescript
import { ConnectivityClientCore } from "@formance/sdk-connectivity/core.js";
import { cashPoolsBalances } from "@formance/sdk-connectivity/funcs/cashPoolsBalances.js";
...
async function run() {
  const res = await cashPoolsBalances(connectivityClient, "<value>", new Date("2024-12-15T00:34:35.957Z"));
