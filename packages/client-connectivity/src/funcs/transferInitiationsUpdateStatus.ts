...
export async function transferInitiationsUpdateStatus(
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => operations.TransferInitiationsUpdateStatusRequest$outboundSchema.parse(value$),
    ...
    const path$ = pathToFunc("/api/payments/transfer-initiations/{transferId}/status")(pathParams$);
