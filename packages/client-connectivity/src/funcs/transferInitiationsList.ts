...
export async function transferInitiationsList(
...
> {
    ...
    const [result$, raw$] = await m$.match<
        ...
        | ConnectionError
    >(
        m$.json(200, operations.TransferInitiationsListResponse$inboundSchema, { key: "Result" }),
    ...
    > => {
        ...
        return () => transferInitiationsList(client$, nextCursor, pageSize, sort, query, options);
    };
