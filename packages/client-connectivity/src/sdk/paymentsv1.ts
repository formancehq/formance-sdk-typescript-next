...
export class PaymentsV1 extends ClientSDK {
    async create(
        ...
        const [result$] = await m$.match<
            operations.PaymentsV1CreateResponseBody,
            errors.PaymentsError | SDKError | SDKValidationError
        >(
            m$.json(200, operations.PaymentsV1CreateResponseBody$inboundSchema),
    ...
    async list(
        ...
        const [result$, raw$] = await m$.match<
            operations.PaymentsV1ListResponse,
            errors.PaymentsError | SDKError | SDKValidationError
        >(
            m$.json(200, operations.PaymentsV1ListResponse$inboundSchema, { key: "Result" }),
            m$.jsonErr("default", errors.PaymentsError$inboundSchema)
        )(response, { extraFields: responseFields$ });
    ...
    async get(
        ...
        const path$ = pathToFunc("/api/payments/payments/{payementId}")(pathParams$);
        ...
        const [result$] = await m$.match<
            operations.PaymentsV1GetResponseBody,
            SDKError | SDKValidationError
        >(
            m$.json(200, operations.PaymentsV1GetResponseBody$inboundSchema),
            m$.fail("default")
        )(response);
    ...
    async updateMetatdata(
        ...
        const path$ = pathToFunc("/api/payments/payments/{paymentId}/metadata")(pathParams$);
