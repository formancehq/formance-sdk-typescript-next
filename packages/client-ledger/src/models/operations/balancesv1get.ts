...
export namespace BalancesV1GetRequest$ {
    export const inboundSchema: z.ZodType<BalancesV1GetRequest, z.ZodTypeDef, unknown> = z
        .object({
            ledger: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BalancesV1GetRequest> = z
        .object({
            ledger: z.string(),
            pageSize: z.string().optional(),
            cursor: z.string().optional(),
...
export namespace BalancesV1GetCursor$ {
    export const inboundSchema: z.ZodType<BalancesV1GetCursor, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BalancesV1GetCursor> = z
        .object({
            next: z.string().optional(),
            data: z.array(z.array(z.record(z.record(z.number().int())))),
        })
...
export namespace BalancesV1GetResponseBody$ {
    export const inboundSchema: z.ZodType<BalancesV1GetResponseBody, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BalancesV1GetResponseBody> = z
        .object({
