...
export * from "./bankaccountrelatedaccount";
...
export * from "./transferinitiationpayment";
export * from "./transferinitiationstatus";
export * from "./transferinitiationtype";
export * from "./transferinitiationwritablestatus";
