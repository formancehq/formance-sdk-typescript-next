...
```bash
npm add @formance/sdk-flows
```

### PNPM

```bash
pnpm add @formance/sdk-flows
```

### Bun

```bash
bun add @formance/sdk-flows
```

### Yarn

```bash
yarn add @formance/sdk-flows zod
...
const sdk = new FlowsClient({ debugLogger: console });
```
<!-- End Debugging [debug] -->
